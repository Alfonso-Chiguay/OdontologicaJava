...
public class AdmBoleta extends javax.swing.JFrame {
    ...
    public AdmBoleta(Empleado emp) {
        ...
        this.setTitle("Clinica Odontológica Linda Sonrisa | Menú Administrador | Administrar boleta");
    ...
    private void initComponents() {
        ...
        btn_anulaElimBol = new javax.swing.JButton();
        ...
        colorBotonTopLayout.setHorizontalGroup(
            ...
            .addGroup(colorBotonTopLayout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(btn_informes, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE))
        );
        ...
        btn_crearBoleta.setBackground(new java.awt.Color(12, 140, 153));
        btn_crearBoleta.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        btn_crearBoleta.setForeground(new java.awt.Color(255, 255, 255));
        btn_crearBoleta.setText("Generar boleta de servicio");
        btn_crearBoleta.setActionCommand("");
        btn_crearBoleta.setAutoscrolls(true);
        btn_crearBoleta.setBorderPainted(false);
        btn_crearBoleta.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        btn_anulaElimBol.setBackground(new java.awt.Color(12, 140, 153));
        btn_anulaElimBol.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        btn_anulaElimBol.setForeground(new java.awt.Color(255, 255, 255));
        btn_anulaElimBol.setText("Anular /Eliminar boleta");
        btn_anulaElimBol.setActionCommand("");
        btn_anulaElimBol.setAutoscrolls(true);
        btn_anulaElimBol.setBorderPainted(false);
        btn_anulaElimBol.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btn_anulaElimBol.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_anulaElimBolActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btn_anulaElimBol, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(464, 464, 464))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(160, 160, 160)
                .addComponent(btn_crearBoleta, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(47, 47, 47)
                .addComponent(btn_anulaElimBol, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_crearBoletaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_crearBoletaActionPerformed
        this.dispose();
        CrearBoleta ventana = new CrearBoleta(empleado);
        ventana.setVisible(true);

    }//GEN-LAST:event_btn_crearBoletaActionPerformed

    private void btn_anulaElimBolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_anulaElimBolActionPerformed
        this.dispose();
        EliminarBoleta ventana = new EliminarBoleta(empleado);
        ventana.setVisible(true);
    }//GEN-LAST:event_btn_anulaElimBolActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdmBoleta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton btn_anulaElimBol;
