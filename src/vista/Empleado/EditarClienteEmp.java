...
public class EditarClienteEmp extends javax.swing.JFrame {


    public EditarClienteEmp() {
        initComponents();
    }
   public Empleado empleado;
   public Cliente cliente;
   
   public EditarClienteEmp(Empleado emp, Cliente cli) {
        initComponents();
        empleado=emp;
        cliente=cli;
        ...
        this.setTitle("Clinica Odontológica Linda Sonrisa | Menú empleado | Editar cliente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarClienteEmp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarClienteEmp().setVisible(true);
            }
        });
    }
