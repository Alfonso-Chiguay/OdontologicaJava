...
public class MenuRegCliente extends javax.swing.JFrame {


    public MenuRegCliente() {
        initComponents();
    }
   public Empleado empleado;
   
   public MenuRegCliente(Empleado emp) {
        initComponents();
        empleado=emp;
    ...
    private void initComponents() {
        ...
        btn_editarCliente.setText("Editar / Buscar");
    ...
    private void btn_crearClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_crearClienteActionPerformed
        this.dispose();
        RegistrarCliente ventana = new RegistrarCliente(empleado);
    ...
    private void btn_editarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarClienteActionPerformed
        this.dispose();
        GestorClienteEmp ventana = new GestorClienteEmp(empleado);
        ventana.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuRegCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuRegCliente().setVisible(true);
            }
        });
    }
